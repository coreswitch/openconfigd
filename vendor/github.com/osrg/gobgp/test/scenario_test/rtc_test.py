...
class GoBGPTestBase(unittest.TestCase):
    ...
    def test_10_rr_setup(self):
        ...
        self.g3.local('gobgp policy statement allow-acme add condition neighbor rr-clients-acme')
        ...
        self.g3.local('gobgp policy statement allow-rtc add condition afi-safi-in rtc')
        self.g3.local('gobgp policy statement allow-rtc add action accept')
        self.g3.local('gobgp policy add allow-rtc allow-rtc')

        self.g3.local('gobgp global policy import add allow-rtc allow-acme default reject')
        self.g3.local('gobgp global policy export add allow-rtc allow-acme default reject')
    ...
    def test_20_rr_and_non_rr_setup(self):
        ...
        self.g3.local('gobgp global policy import set allow-rtc allow-rr-peers allow-acme default reject')
        self.g3.local('gobgp global policy export set allow-rtc allow-rr-peers allow-acme default reject')
